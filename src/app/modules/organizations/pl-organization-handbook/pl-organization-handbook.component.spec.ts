...
import { PLSchoolYearsService } from '@root/src/app/common/services/pl-school-years.service';
...
import { PLOrganizationHandbookComponent } from '..';

describe('PLOrganizationHandbookComponent', () => {
    let spectator: Spectator<PLOrganizationHandbookComponent>;

    const createComponent = createComponentFactory({
        component: PLOrganizationHandbookComponent,
        declarations: [
            PLDotLoaderComponent, MockComponent(PLSchoolyearSelectComponent),
            MockComponent(PLHandbookContentsComponent), MockComponent(PLHandbookTextEditorComponent),
            PLIconComponent,
        ],
        mocks: [
            Router, Store, PLBrowserService, PLOrganizationsService, PLSchoolYearsService,
    ...
    describe('PL School Year', () => {
        ...
        beforeEach(() => plSchoolYearSvcMock = spectator.inject(PLSchoolYearsService));
    ...
    describe('CanActivate Guard', () => {
        ...
        it('should stop routing when Text Editor is activated', () => {
            ...
            // const storeSpy = spyOn<any>(Store, 'dispatch');
