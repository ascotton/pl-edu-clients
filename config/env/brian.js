module.exports = {
  ...
  apps: {
    ...
    apiWorkplace: {
      url: 'https://brian.workplace.presencestag.com',
    },
    auth: {
      url: 'https://brian.login.presencestag.com',
    },
    admin: {
      url: process.env.ADMIN_URL || 'https://apps.presencetest.com/admin',
    },
    apollo: {
      url: 'https://brian.workplace.presencestag.com/graphql/v1/',
    },
    apps: {
      url: process.env.APPS_URL || 'https://brian.apps.presencetest.com',
    },
    components: {
